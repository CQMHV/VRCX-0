...
function DialogOverlay({
    ...
    return (
        <DialogPrimitive.Backdrop
            ...
            className={cn(
                'vrcx-0-app-overlay data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed isolate z-50 bg-black/10 data-closed:duration-100 data-open:duration-150 supports-backdrop-filter:backdrop-blur-xs',
                className
            )}
            {...props}
        />
